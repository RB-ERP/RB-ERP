  ...
  <body>
    <div class="sidebar">
      ...
      <ul>
        ...
        <li>
            <a href="{{ route('superadmin.laporan')}}" class="active">
    ...
    <div class="main-content">
        <div class="header">
          ...
          <div class="header-content">
            ...
            <form method="GET" action="{{ route('superadmin.laporan') }}" class="form-filter">
                <input type="text" id="searchInput" class="search-bar" placeholder="Cari Nama Barang" name="nama_barang" value="{{ request('nama_barang') }}">
                ...
                <input type="number" name="tahun" id="tahun" value="{{ request('tahun') }}" placeholder="Semua Tahun">
          ...
          <div class="data-barang-actions">
              <button class="btn-pdf" onclick="window.location.href='{{ route('superadmin.laporan.pdf', ['mulai' => request('mulai'), 'selesai' => request('selesai')]) }}'">
