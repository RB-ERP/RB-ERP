...
<html lang="id">
  <head>
    ...
    <title>Laporan Pembaharuan Data Barang - InvenTrack</title>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap" rel="stylesheet" />
    <link rel="stylesheet" href="/css/laporanpembaruan.css" />
  </head>
    ...
    <div class="main-content">
      <div class="header">
        ...
        <div class="header-content">
            <h1>Laporan Pembaruan Data Barang</h1>
      ...
      <div class="data-barang-actions">
        <button class="btn-pdf" onclick="window.location.href='{{ route('superadmin.laporanpembaruan.pdf', ['mulai' => request('mulai'), 'selesai' => request('selesai')]) }}'">
