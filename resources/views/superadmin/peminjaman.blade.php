    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <ul>
                ...
                <li>
                    <a href="{{ route('superadmin.databarang') }}"> <img src="/asset/databarang.png"
                            alt="Data Icon" />Data
                        Barang </a>
                </li>
                <li class="dropdown">
        ...
        @elseif($barangAvailable->status == 'Pengajuan Peminjaman')
                            ...
                            <tr>
                                ...
                                <td class="action-style">
                                    @if ($barangDipinjam->status == 'Dipinjam')
                                        <button class="borrow-button return-btn" data-id="{{ $barangDipinjam->id }}">
                                            <i class="fa-solid fa-reply marginRight"></i> Kembalikan Shekarang
                                        </button>
                                    @elseif($barangDipinjam->status == 'Pengajuan Pengembalian')
                                        <button class="detail-button" disabled data-id="{{ $barangDipinjam->id }}">
                                            <i class="fa-regular fa-clock marginRight"></i> Sedang diajukan
                                        </button>
                                    @endif
                                    <button class="detail-button"
                                        onclick="openModal('{{ $barangDipinjam->nama_barang }}', '{{ $barangAvailable->kode_barang }}', '{{ $barangAvailable->tanggal_pembelian }}', '{{ $barangAvailable->spesifikasi }}', '{{ $barangAvailable->harga }}', '{{ $barangAvailable->status }}')">
                                        <i class="fa-solid fa-circle-info"></i>
                                    </button>
                                </td>
                            </tr>
            ...
            <script>
                ...
                // Pilih semua tombol dengan kelas 'pinjamBtn'
