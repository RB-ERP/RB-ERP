      ...
      <table class="data-barang-table">
        ...
        <tbody>
            @foreach ($barangs as $barang)
                <tr>
                    ...
                    <td>
                        <!-- Tombol Hapus -->
                        <form id="delete-form-{{ $barang->id }}" action="{{ route('perbaikanbarang.destroy', $barang->id) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
        ...
        <script>
            ...
            function generatePDF() {
                ...
                let url = '{{ route("perbaikanbarang.pdf") }}'; // Rute diperbaiki
