    ...
    <div class="main-content">
        <div class="header">
            <div class="navbar">
                ...
                <div class="user-info">
                    <a href="{{ route('user.notifikasi') }}" class="notification-icon2">
            ...
            <div class="notification-content">
                ...
                <div class="notification-list">
                    @if ($notifikasiBelumDibaca->isEmpty())
                        <p style="text-align: center; color: #6b7280;">Belum ada pengajuan terbaru.</p>
                    @else
                        @foreach ($notifikasiBelumDibaca as $notif)
                            <div class="notification-item" data-id="{{ $notif->id }}">
                                ...
                                <div class="right-section">
                                    ...
                                    <span class="notification-status" style="background-color: rgb(235, 161, 2)">Dalam Pengajuan</span>
                                </div>
