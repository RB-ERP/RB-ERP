...
<body>
    <div class="sidebar">
        ...
        <ul>
            <li>
                <a href="{{ route('admin.dashboard') }}"> <img src="/asset/dashboard.png"
                        alt="Dashboard Icon" />Dashboard </a>
            </li>
            <li>
                <a href="{{ route('admin.databarang') }}" class="active"> <img src="/asset/databarang.png"
                    ...
                    @foreach ($barangs as $barang)
                        <tr>
                            ...
                            <td>
                                <!-- Tombol Edit -->
                                <a
                                    href="{{ route('admin.barang.edit', ['id' => $barang->id, 'source' => 'databarang']) }}">
