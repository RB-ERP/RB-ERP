...
<html lang="en">
  ...
  <body>
    <div class="sidebar">
      ...
      <ul>
        <li>
            <a href="{{ route('admin.dashboard') }}"> <img src="/asset/dashboard.png" alt="Dashboard Icon" />Dashboard </a>
        </li>
        <li>
            <a href="{{ route('admin.databarang') }}" class="active"> <img src="/asset/databarang.png" alt="Data Icon" />Data Barang </a>
        </li>
        <li class="dropdown">
    ...
    <div class="main-content">
      < class="header">
        ...
        <div class="data-barang-actions">
          ...
          onclick="window.location.href='{{ route('admin.barang.pdf', request()->query()) }}'">
        ...
        <table class="data-barang-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <!-- Tombol Edit -->
                <a href="{{ route('admin.barang.edit', ['id' => $barang->id, 'source' => 'databarang']) }}">
