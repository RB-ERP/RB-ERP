  ...
  <body>
            ...
            <tbody>
                @foreach ($barangs as $barang)
                    <tr>
                        ...
                        <td>
                            <!-- Tombol Hapus -->
                            <form id="delete-form-{{ $barang->id }}" action="{{ route('admin.upgradebarang.destroy', $barang->id) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
    ...
    <script>
        ...
        function generatePDF() {
            ...
            // Ambil URL dari route dan buat parameter filter
            let url = '{{ route("admin.upgradebarang.pdf") }}';
