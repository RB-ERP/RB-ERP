    ...
    <div class="main-content">
        ...
        <script>
            function generatePDF() {
                ...
                // Buat URL untuk route generatePDF dengan query parameters
                let url = '{{ route('admin.pengembalian.pdf') }}';

                // Tambahkan query parameters jika ada input tanggal
                ...
                // Arahkan ke URL dengan query parameters
